...
var Token = /** @class */ (function () {
    function Token(token_type, literal) {
        this.token_type = token_type;
        this.literal = literal;
    }
    Token.prototype.toString = function () {
        return "Type TokenType.".concat(obtenerNombreDeEnum(TokenType, this.token_type), ", Literal ").concat(this.literal);
    };
    Token.prototype.equals = function (t) {
